...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get helpMode1Details =>
      '• Езикови настройки: Променете моя език и езика за обучение чрез менюто на лентата с приложения или бутона за език в долната част\n• Опростено въвеждане: Автоматичен анализ (дума/изречение) и активиране на зоната за настройки при въвеждане на текст\n• Микрофон/клавиатура: Започнете разпознаване на глас или въвеждане на текст с голямата икона на главния екран\n• Разширени настройки: Определете сборник с материали, таг, бележка за ситуацията в долната част, която се появява по време на въвеждане\n• Автоматично търсене: Откриване на подобни съществуващи преводи в реално време\n• Слушане: Пуснете произношение от носител на езика (TTS) с иконата на високоговорителя\n• Запазване: Незабавно добавете към вашия собствен списък за обучение с „Запазване на данни“';
  ...
  String get welcomeDesc =>
      'Talkie поддържа над 80 езика и е интелигентен инструмент за превод за пътешественици и изучаващи езици. Подобрете говоренето си с AI Chat!';
