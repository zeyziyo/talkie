...
class AppLocalizationsFil extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'Naubos na ang pang-araw-araw na quota para sa serbisyo ng AI. Subukang muli mamaya o bukas.';
  ...
  String get helpMode2Details =>
      '• Pumili ng set ng aralin: Gamitin ang \'Pumili ng set ng aralin\' o \'Online Library\' sa menu (⋮) sa kanang itaas\n• Baliktarin ang card: Kumpirmahin ang pagsasalin gamit ang \'Ipakita/Itago\'\n• Pakinggan: I-play ang pagbigkas gamit ang icon ng speaker\n• Tapos na ang pag-aaral: Markahan bilang tapos na ang pag-aaral gamit ang check (V)\n• Tanggalin: Pindutin nang matagal (Long Click) ang card para tanggalin ang tala\n• Paghahanap at Filter: Suportado ang search bar (real-time smart search) at mga tag, mga filter ng panimulang letra';
  ...
  String get scanNoMatch =>
      'Walang mahanap na tekstong tumutugma sa wikang ginamit sa pagsasanay na nakatakda sa litrato. Pakisuri ang mga setting ng wika.';
  ...
  String get translationLimitMessage =>
      'Naubos mo na ang iyong pang-araw-araw na libreng pagsasalin (10 beses).\\n\\nGusto mo bang manood ng ad upang agad na mag-refill ng 10 beses?';
  ...
  String get translationRefilled =>
      'Ang bilang ng pagsasalin ay na-refill ng 10 beses!';
  ...
  @override
  String get watchAdAndRefill => 'Manood ng Ad at Mag-refill (+10 beses)';
  ...
  String get errorLimitReached =>
      'Kulang ka na sa bilang ng pagsasalin. Gusto mo bang manood ng ad para makakuha ng 10 karagdagang pagsasalin?';
  ...
  String get helpLimitDetails =>
      '💡 [Gabay sa Limitasyon ng Pagsasalin]\n20 libreng pagsasalin ang ibinibigay araw-araw sa hatinggabi. Kung maubos mo ang lahat, maaari kang manood ng ad para makakuha agad ng 10 karagdagang pagsasalin.';

  @override
  String get scanDetails =>
      '• Mag-import ng mga larawan mula sa camera o gallery upang kunin at isalin ang teksto.\n• Maaari mong i-tap ang ilang pangungusap sa isang larawan upang isalin ang mga ito nang paisa-isa.\n• Kung kulang ka sa bilang ng pagsasalin, maaari kang manood agad ng ad para makakuha ng 10 karagdagang pagsasalin.';
}
