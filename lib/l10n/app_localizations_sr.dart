...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'Искоришћена је дневна квота за услугу вештачке интелигенције. Покушајте поново касније или сутра.';

  @override
  String get errorSafetyPolicy =>
      'Превод је ограничен због политике безбедности вештачке интелигенције.';

  @override
  String get copyOriginal => 'Копирај оригинал';

  @override
  String get originalCopied => 'Оригинални текст је копиран.';
  ...
  @override
  String get extractedText => 'Препознати текст';
  ...
  @override
  String get helpTabQuickStart => 'Брзи почетак';
  ...
  String importFolderSuccess(num files, num entries) {
    return '$files датотека, $entries ставки је увезено.';
  }
  ...
  @override
  String get importSourceFile => 'Једна JSON датотека';

  @override
  String get importSourceFolder => 'Фасцикла (структура библиотеке по језику)';

  @override
  String get importSourceTitle => 'Изаберите извор увоза';

  @override
  String get importSourceZip => 'ZIP датотека (компресована фасцикла)';
  ...
  @override
  String get pickGallery => 'Изаберите из галерије';
  ...
  @override
  String get processing => 'Обрада у току...';
  ...
  String get quickStartStep1Desc =>
      'Прво изаберите свој језик и језик за учење у Мени > Подешавање језика.';

  @override
  String get quickStartStep1Title => '1. Подешавање језика';

  @override
  String get quickStartStep2Desc =>
      'Направите своје картице за учење редоследом: Унос (микрофон/тастатура) -> Превод -> Сачувај.';

  @override
  String get quickStartStep2Title => '2. Основни ток';
  ...
  @override
  String get quickStartStep3Title => '3. Коришћење режима';
  ...
  @override
  String get saveAsSentence => 'Сачувај као реченицу';

  @override
  String get saveAsWord => 'Сачувај као реч';
  ...
  @override
  String get saveToHistory => 'Сачувај у историју скенирања';
  ...
  @override
  String get scanInstructions => 'Изаберите слику за скенирање';

  @override
  String get scanNoMatch =>
      'На слици није пронађен текст који одговара подешеном језику за учење. Проверите подешавања језика.';

  @override
  String get scanNotSupported =>
      'Скенирање није подржано за овај језик. OCR тренутно подржава само латинично, кинеско, деванагари (као што је хинди), јапанско и корејско писмо.';
  ...
  String get translationLimitMessage =>
      'Искористили сте све бесплатне дневне преводе (10 пута).\\n\\nДа ли желите одмах да допуните 10 пута гледањем огласа?';

  @override
  String get translationLoaded => 'Учитан сачувани превод';

  @override
  String get translationRefilled => 'Број превода је допуњен 10 пута!';
  ...
  @override
  String get typeProverb => 'Пословица';
  ...
  @override
  String get watchAdAndRefill => 'Допуните гледањем огласа (+10 пута)';
  ...
  String get scanTranslateMethodSubtitle =>
      'Како да преведем препознати текст?';

  @override
  String get scanBulkTranslate => 'Превод целог текста';

  @override
  String get scanBulkTranslateDesc => 'Преведите цео текст једним захтевом';

  @override
  String get scanSegmentTranslate => 'Појединачни превод';

  @override
  String get scanSegmentTranslateDesc =>
      'Појединачно бирајте сегменте за превођење';

  @override
  String get scanTranslatingAll => 'Превод целог текста у току...';

  @override
  String get scanBulkTranslateButton => 'Преведи цео текст';

  @override
  String scanInsufficientLimit(int needed, int remaining) {
    return 'Немате довољно превода. Потребно: $needed, преостало: $remaining';
  }

  @override
  String get combinedResult => 'Комбиновани резултат';

  @override
  String get errorLimitReached =>
      'Немате довољно превода. Да ли желите да погледате рекламу и добијете 10 превода?';
  ...
  String get helpLimitDetails =>
      '💡 [Упутство за ограничење превода]\nСваког дана у поноћ се додељује 20 бесплатних превода. Чак и ако их све искористите, можете одмах добити додатних 10 превода гледањем рекламе.';

  @override
  String get scanDetails =>
      '• Увезите слике из камере или галерије да бисте издвојили и превели текст.\n• Можете да додирнете и појединачно преведете више реченица на једној фотографији.\n• Ако немате довољно превода, можете одмах да погледате оглас да бисте добили додатних 10 превода.';
}
