...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'Дневниот лимит за услугите со вештачка интелигенција е исцрпен. Обидете се повторно подоцна или утре.';

  @override
  String get errorSafetyPolicy =>
      'Преводот е ограничен поради политиката за безбедност на вештачката интелигенција.';

  @override
  String get copyOriginal => 'Копирај оригинал';

  @override
  String get originalCopied => 'Оригиналниот текст е копиран.';
  ...
  String get helpMode1Desc =>
      'Започнете да учите јазици на најинтуитивен начин преку премиум 3D микрофон и голема икона за тастатура.';

  @override
  String get helpMode1Details =>
      '• Поставување јазик: Проверете го вашиот јазик и јазикот што го учите и сменете го јазикот за учење со копчето за јазик на горниот дел од почетниот екран.\n• Едноставен влез: Внесете веднаш преку големиот микрофон и текстуалниот прозорец во центарот.\n• Проверете ги поставките: Кликнете на синото копче за проверка десно по завршувањето на внесувањето. Ќе се појави прозорец за детални поставки.\n• Детални поставки: Можете да ја наведете збирката на материјали за зачувување, белешките и ознаките во дијалогот што се појавува.\n• Преведи сега: Откако ќе ги завршите поставките, кликнете на зеленото копче за превод за да дозволите вештачката интелигенција веднаш да изврши превод.\n• Автоматско пребарување: Открива и прикажува слични постоечки преводи во реално време додека пишувате.\n• Слушајте и зачувајте: Слушајте го изговорот со иконата за звучник на дното на резултатот од преводот и додајте го на списокот за учење преку „Зачувај податоци“.';
  ...
  String get helpMode2Details =>
      '• Избор на материјали: Користете го менито (⋮) горе десно за да изберете \'Избор на материјали за учење\' или \'Онлајн библиотека\'\n• Превртување на картичката: Користете \'Прикажи/Сокриј\' за да го проверите преводот\n• Слушање: Иконата на звучник за репродукција на изговорот\n• Завршено учење: Означете (V) за да го означите учењето како завршено\n• Бришење: Долго притиснете на картичката за да ја избришете историјата\n• Пребарување и филтрирање: Поддршка за лентата за пребарување (паметно пребарување во живо) и ознаки, филтри за почетна буква';
  ...
  String get scanNoMatch =>
      'Не може да се најде текст на фотографијата што се совпаѓа со поставениот јазик за учење. Проверете ги поставките за јазик.';

  @override
  String get scanNotSupported =>
      'Скенирањето не е поддржано за овој јазик. OCR моментално поддржува само латиница, кинески, деванагари (хинди итн.), јапонски, корејски знаци.';
  ...
  String get translationLimitMessage =>
      'Ги искористивте сите бесплатни дневни преводи (10 пати).\\n\\nДали сакате да видите реклама и веднаш да надополните 10 пати?';

  @override
  String get translationLoaded => 'Зачуваниот превод е вчитан';

  @override
  String get translationRefilled => 'Бројот на преводи е надополнет 10 пати!';
  ...
  @override
  String get watchAdAndRefill => 'Види реклама и надополни (+10 пати)';
  ...
  String get scanAdRefillNotice =>
      'За да го надополните бројот на преводи, притиснете го копчето подолу и погледнете реклама. Кликнувањето на банер-рекламата на дното на екранот не обезбедува надополнување.';
  ...
  String get scanTranslateMethodSubtitle =>
      'Како сакате да го преведете препознаениот текст?';

  @override
  String get scanBulkTranslate => 'Превод на цел текст';

  @override
  String get scanBulkTranslateDesc =>
      'Преведете го целиот текст со едно барање';

  @override
  String get scanSegmentTranslate => 'Поединечен превод';

  @override
  String get scanSegmentTranslateDesc =>
      'Изберете сегменти за превод поединечно';

  @override
  String get scanTranslatingAll => 'Се преведува целиот текст...';

  @override
  String get scanBulkTranslateButton => 'Преведи го целиот текст';

  @override
  String scanInsufficientLimit(int needed, int remaining) {
    return 'Немате доволно преводи. Потребни: $needed, Остануваат: $remaining';
  }

  @override
  String get combinedResult => 'Комбиниран резултат';

  @override
  String get errorLimitReached =>
      'Немате доволно преводи. Дали сакате да гледате реклама за да добиете 10 повеќе?';
  ...
  String get helpLimitDetails =>
      '💡 [Водич за лимит за превод]\nСекој ден на полноќ добивате 20 бесплатни преводи. Ако ги искористите сите, можете да гледате реклама за веднаш да добиете дополнителни 10 преводи.';

  @override
  String get scanDetails =>
      '• Поставете слика од камера или галерија за да извлечете и преведете текст.\n• Можете да допрете повеќе реченици во една фотографија за да ги преведете поединечно.\n• Ако немате доволно преводи, можете веднаш да гледате реклама за да добиете дополнителни 10.';
}
