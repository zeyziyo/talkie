...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'Жасанды интеллект қызметінің күндік лимиті таусылды. Кейінірек немесе ертең қайтадан көріңіз.';

  @override
  String get errorSafetyPolicy =>
      'Жасанды интеллект қауіпсіздік саясатына байланысты аударма шектелген.';

  @override
  String get copyOriginal => 'Түпнұсқаны көшіру';

  @override
  String get originalCopied => 'Түпнұсқа мәтін көшірілді.';
  ...
  @override
  String get extractedText => 'Тан алынған мәтін';
  ...
  String get helpMode1Desc =>
      'Үлкен клавиатура белгішесі және премиум 3D микрофоны арқылы тіл үйренуді ең түсінікті жолмен бастаңыз.';

  @override
  String get helpMode1Details =>
      '• Тіл параметрлері: Басты экранның жоғарғы жағындағы тіл батырмасы арқылы өз тіліңізді және үйреніп жатқан тіліңізді тексеріп, оқу тілін өзгерте аласыз.\n• Қарапайым енгізу: Ортадағы үлкен микрофон мен мәтін терезесі арқылы бірден енгізіңіз.\n• Параметрлерді тексеру: Енгізу аяқталғаннан кейін оң жақтағы көк белгішесін басыңыз. Толық параметрлер терезесі пайда болады.\n• Толық параметрлер: Пайда болған диалогта сақталатын деректер жинағын, аннотацияны (ескертпе), тегті көрсетуге болады.\n• Дереу аудару: Параметрлерді аяқтағаннан кейін жасыл аударма батырмасын бассаңыз, жасанды интеллект бірден аударманы орындайды.\n• Автоматты іздеу: Енгізу кезінде ұқсас бар аударманы нақты уақытта анықтап көрсетеді.\n• Тыңдау және сақтау: Аудару нәтижесінің астындағы динамик белгішесі арқылы дыбысталуды тыңдап, \'Деректерді сақтау\' арқылы оқу тізіміне қосыңыз.';
  ...
  String get helpMode2Details =>
      '• Деректер жинағын таңдау: Оң жақ жоғарғы мәзірден (⋮) «Оқу деректер жинағын таңдау» немесе «Онлайн деректер қорын» пайдаланыңыз.\n• Картаны аудару: «Көрсету/жасыру» арқылы аударманы тексеріңіз.\n• Тыңдау: Динамик белгішесі арқылы дыбыстауды ойнатыңыз.\n• Оқуды аяқтау: Белгішемен (V) оқуды аяқтауды өңдеңіз.\n• Жою: Жазбаны жою үшін картаны ұзақ басыңыз (Ұзақ шерту).\n• Іздеу және сүзгі: Іздеу жолағын (нақты уақыттағы смарт іздеу) және тегтерді, бастапқы әріп сүзгісін қолдау.';
  ...
  @override
  String get helpTabQuickStart => 'Жылдам бастау';
  ...
  String importFolderSuccess(num files, num entries) {
    return '$files файл, $entries жазба импортталды.';
  }
  ...
  @override
  String get importSourceFile => 'Жалғыз JSON файлы';

  @override
  String get importSourceFolder =>
      'Қапшық (тілге байланысты кітапхана құрылымы)';

  @override
  String get importSourceTitle => 'Импорттау көзін таңдау';

  @override
  String get importSourceZip => 'ZIP файлы (қысылған қалта)';
  ...
  String get noDataForLanguage =>
      'Тіліңізге арналған оқу деректері жергілікті деректер базасында жоқ. Деректерді жүктеп алыңыз немесе басқа тілді таңдаңыз.';
  ...
  @override
  String get pickGallery => 'Галереядан таңдау';
  ...
  String get quickStartStep1Desc =>
      'Мәзір > Тілді орнату бөлімінен өз тіліңізді және оқу тілін алдымен көрсетіңіз.';

  @override
  String get quickStartStep1Title => '1. Тілді орнату';

  @override
  String get quickStartStep2Desc =>
      'Кіріс (микрофон/пернетақта) -> Аударма -> Сақтау ретімен өзіңіздің оқу картаңызды жасаңыз.';

  @override
  String get quickStartStep2Title => '2. Негізгі ағын';
  ...
  @override
  String get quickStartStep3Title => '3. Режимді пайдалану';
  ...
  @override
  String get saveAsSentence => 'Сөйлем ретінде сақтау';

  @override
  String get saveAsWord => 'Сөз ретінде сақтау';
  ...
  @override
  String get saveToHistory => 'Сканерлеу тарихына сақтау';
  ...
  @override
  String get originalText => 'Түпнұсқа мәтін';
  ...
  String get scanNoMatch =>
      'Фотосуретте орнатылған оқу тіліне сәйкес келетін мәтін табылмады. Тіл параметрлерін тексеріңіз.';
  ...
  String get translationLimitMessage =>
      'Күнделікті тегін аударманы (10 рет) толығымен пайдаландыңыз.\\n\\nЖарнаманы көріп, 10 рет тез арада толтырғыңыз келе ме?';

  @override
  String get translationLoaded => 'Сақталған аударма жүктелді';

  @override
  String get translationRefilled => 'Аударма саны 10 ретке толтырылды!';
  ...
  @override
  String get watchAdAndRefill => 'Жарнаманы көріп толтыру (+10 рет)';
  ...
  String get welcomeDesc =>
      'Talkie-ге қош келдіңіз! Біз дүние жүзіндегі 80-нен астам тілді 100% қолдаймыз және жаңа премиум 3D дизайны мен оңтайландырылған өнімділігімен тамаша оқу тәжірибесін ұсынамыз.';
  ...
  String get errorLimitReached =>
      'Аударма саны жеткіліксіз. Жарнаманы көріп, 10 рет толтырғыңыз келеді ме?';
  ...
  String get helpLimitDetails =>
      '💡 [Аударма лимиті туралы ақпарат]\nКүн сайын түн ортасында 20 тегін аударма беріледі. Барлығын тауысқаннан кейін де жарнаманы көрсеңіз, 10 қосымша аударма дереу толықтырылады.';

  @override
  String get scanDetails =>
      '• Камерадан немесе галереядан суреттерді жүктеп, мәтінді шығарып аударыңыз.\n• Бір фотосуреттегі бірнеше сөйлемді түртіп, жеке аударуға болады.\n• Аударма саны жеткіліксіз болса, 10 рет қосымша толықтыру үшін жарнаманы дереу көруге болады.';
}
