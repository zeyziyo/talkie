...
class AppLocalizationsTe extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'AI సేవల కోసం మీ రోజువారీ కోటా అయిపోయింది. దయచేసి కొంత సమయం తర్వాత లేదా రేపు మళ్లీ ప్రయత్నించండి.';

  @override
  String get errorSafetyPolicy =>
      'AI భద్రతా విధానం కారణంగా అనువాదం పరిమితం చేయబడింది.';

  @override
  String get copyOriginal => 'అసలు ప్రతిని కాపీ చేయండి';

  @override
  String get originalCopied => 'అసలు టెక్స్ట్ కాపీ చేయబడింది.';
  ...
  String get helpMode1Desc =>
      'ప్రీమియం 3D మైక్రోఫోన్ మరియు పెద్ద కీబోర్డ్ చిహ్నంతో అత్యంత స్పష్టమైన రీతిలో భాషా అభ్యాసాన్ని ప్రారంభించండి.';

  @override
  String get helpMode1Details =>
      'భాషా సెట్టింగులు: హోమ్ స్క్రీన్ పైభాగంలో ఉన్న భాషా బటన్ ఉపయోగించి నా భాషను మరియు నేను నేర్చుకుంటున్న భాషను ధృవీకరించండి మరియు అభ్యాస భాషను మార్చవచ్చు.\n• సాధారణ ఇన్‌పుట్: మధ్యలో ఉన్న పెద్ద మైక్రోఫోన్ మరియు టెక్స్ట్ విండో ద్వారా వెంటనే ఇన్‌పుట్ చేయండి.\n• సెట్టింగులను తనిఖీ చేయండి: ఇన్‌పుట్ పూర్తయిన తర్వాత, కుడివైపున ఉన్న నీలం రంగు చెక్ బటన్‌ను నొక్కండి. వివరణాత్మక సెట్టింగ్‌ల విండో కనిపిస్తుంది.\n• వివరణాత్మక సెట్టింగ్‌లు: కనిపించే డైలాగ్‌లో, సేవ్ చేయడానికి డేటా సేకరణ, వ్యాఖ్యలు (మెమోలు) మరియు ట్యాగ్‌లను పేర్కొనవచ్చు.\n• ఇప్పుడే అనువదించు: సెట్టింగ్‌లను పూర్తి చేసిన తర్వాత, ఆకుపచ్చ అనువాద బటన్‌ను నొక్కడం ద్వారా కృత్రిమ మేధస్సు వెంటనే అనువాదం చేస్తుంది.\n• ఆటోమేటిక్ శోధన: ఇన్‌పుట్ చేస్తున్నప్పుడు, ఇది నిజ సమయంలో సారూప్యమైన ఇప్పటికే ఉన్న అనువాదాలను గుర్తించి చూపుతుంది.\n• వినండి మరియు సేవ్ చేయండి: అనువాద ఫలితం దిగువన ఉన్న స్పీకర్ చిహ్నంతో ఉచ్ఛారణను వినండి మరియు \'డేటా సేవ్\' ద్వారా అభ్యాస జాబితాకు జోడించండి.';
  ...
  String get helpMode2Details =>
      '• స్టడీ మెటీరియల్ ఎంచుకోండి: కుడి ఎగువ మెనూ(⋮) నుండి \'స్టడీ మెటీరియల్ ఎంచుకోండి\' లేదా \'ఆన్‌లైన్ మెటీరియల్ లైబ్రరీ\' ఉపయోగించండి\n• కార్డును తిప్పండి: అనువాదం చూడటానికి \'చూపించు/దాచు\' ఉపయోగించండి\n• వినండి: స్పీకర్ చిహ్నంతో ఉచ్ఛారణ ప్లే చేయండి\n• అభ్యాసం పూర్తయింది: చెక్ మార్క్ (V)తో అభ్యాసం పూర్తయినట్లు గుర్తించండి\n• తొలగించు: రికార్డును తొలగించడానికి కార్డును ఎక్కువసేపు నొక్కండి (లాంగ్ క్లిక్ చేయండి)\n• శోధన & ఫిల్టర్: శోధన పట్టీ (రియల్ టైమ్ స్మార్ట్ శోధన) మరియు ట్యాగ్‌లు, ప్రారంభ అక్షరాల ఫిల్టర్‌కు మద్దతు ఉంది';
  ...
  @override
  String get originalText => 'అసలు టెక్స్ట్';
  ...
  String get scanNoMatch =>
      'చిత్రంలో సెట్ చేయబడిన అభ్యాస భాషకు సరిపోయే టెక్స్ట్ కనుగొనబడలేదు. భాషా సెట్టింగ్‌లను తనిఖీ చేయండి.';

  @override
  String get scanNotSupported =>
      'ఈ భాష స్కాన్ చేయడానికి మద్దతు ఇవ్వదు. OCR ప్రస్తుతం లాటిన్, చైనీస్, దేవనాగరి (హిందీ మొదలైనవి), జపనీస్, కొరియన్ అక్షరాలను మాత్రమే మద్దతు ఇస్తుంది.';
  ...
  String get translationLimitMessage =>
      'మీ రోజువారీ ఉచిత అనువాదాలను (10 సార్లు) మీరు ఉపయోగించారు.\\n\\nమీరు ప్రకటన చూసి వెంటనే 10 సార్లు రీఫిల్ చేయాలనుకుంటున్నారా?';
  ...
  String get translationRefilled =>
      'అనువాదాల సంఖ్య 10 సార్లు రీఫిల్ చేయబడింది!';
  ...
  @override
  String get watchAdAndRefill => 'ప్రకటన చూసి రీఫిల్ చేయండి (+10 సార్లు)';
  ...
  String get scanTranslateMethodSubtitle =>
      'గుర్తించబడిన టెక్స్ట్‌ను ఎలా అనువదించాలి?';

  @override
  String get scanBulkTranslate => 'మొత్తం బల్క్ అనువాదం';

  @override
  String get scanBulkTranslateDesc =>
      'ఒకే అభ్యర్థనతో మొత్తం వచనాన్ని అనువదించండి';

  @override
  String get scanSegmentTranslate => 'వ్యక్తిగత అనువాదం';

  @override
  String get scanSegmentTranslateDesc =>
      'అనువదించడానికి విభాగాలను విడిగా ఎంచుకోండి';

  @override
  String get scanTranslatingAll => 'మొత్తం అనువదిస్తోంది...';

  @override
  String get scanBulkTranslateButton => 'మొత్తం అనువదించు';

  @override
  String scanInsufficientLimit(int needed, int remaining) {
    return 'మీ అనువాదాల సంఖ్య తక్కువగా ఉంది. అవసరం: $needed, మిగిలింది: $remaining';
  }

  @override
  String get combinedResult => 'సమ్మిళిత ఫలితం';

  @override
  String get errorLimitReached =>
      'మీ అనువాదాల సంఖ్య తక్కువగా ఉంది. ప్రకటన చూసి 10 రీఛార్జ్ చేయాలా?';
  ...
  String get helpLimitDetails =>
      '💡 [అనువాద పరిమితి గైడ్]\nప్రతిరోజూ అర్ధరాత్రి 20 ఉచిత అనువాదాలు అందించబడతాయి. మీరు వాటన్నింటినీ ఉపయోగించినప్పటికీ, ప్రకటన చూడటం ద్వారా మీరు వెంటనే 10 అదనపు అనువాదాలను రీఛార్జ్ చేసుకోవచ్చు.';

  @override
  String get scanDetails =>
      '• కెమెరా లేదా గ్యాలరీ నుండి చిత్రాన్ని అప్‌లోడ్ చేయండి మరియు వచనాన్ని సంగ్రహించి అనువదించండి.\n• ఒక చిత్రంలో ఉన్న అనేక వాక్యాలను వ్యక్తిగతంగా అనువదించడానికి మీరు వాటిని నొక్కవచ్చు.\n• మీ అనువాదాల సంఖ్య తక్కువగా ఉంటే, మీరు వెంటనే ప్రకటన చూడటం ద్వారా అదనంగా 10ని రీఛార్జ్ చేసుకోవచ్చు.';
}
