...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get errorQuotaExceeded =>
      'A cota diária do serviço de IA foi excedida. Tente novamente mais tarde ou amanhã.';

  @override
  String get errorSafetyPolicy =>
      'A tradução foi restrita devido à política de segurança da IA.';

  @override
  String get copyOriginal => 'Copiar original';

  @override
  String get originalCopied => 'Texto original copiado.';
  ...
  @override
  String get extractedText => 'Texto reconhecido';
  ...
  String importFolderSuccess(num files, num entries) {
    return '$files ficheiros, $entries entradas importadas.';
  }
  ...
  @override
  String get importSourceFile => 'Ficheiro JSON único';

  @override
  String get importSourceFolder => 'Pasta (estrutura de biblioteca por idioma)';

  @override
  String get importSourceTitle => 'Selecionar origem da importação';

  @override
  String get importSourceZip => 'Ficheiro ZIP (pasta comprimida)';
  ...
  String get noDataForLanguage =>
      'Não há materiais de aprendizado para o idioma selecionado no banco de dados local. Por favor, baixe os materiais ou selecione outro idioma.';
  ...
  String get noteGuidance =>
      'Insira detalhes adicionales para uma tradução mais precisa';
  ...
  @override
  String get pickGallery => 'Selecionar da galeria';
  ...
  @override
  String get requestTranslation => 'Solicitar tradução';
  ...
  @override
  String get saveAsSentence => 'Guardar como frase';

  @override
  String get saveAsWord => 'Guardar como palavra';
  ...
  @override
  String get saveToHistory => 'Guardar no histórico de digitalização';
  ...
  @override
  String get scanInstructions => 'Selecione uma imagem para digitalizar';

  @override
  String get scanNoMatch =>
      'Nenhum texto correspondente ao idioma de aprendizado definido foi encontrado na foto. Verifique as configurações de idioma.';

  @override
  String get scanNotSupported =>
      'Este idioma não oferece suporte ao recurso de digitalização. Atualmente, o OCR só oferece suporte a caracteres latinos, chineses, devanágari (como hindi), japoneses e coreanos.';
  ...
  String statusRequestFailed(String error) {
    return 'Falha ao solicitar tradução: $error';
  }

  @override
  String get statusRequestSuccess => 'Pedido de tradução concluído.';
  ...
  @override
  String get studyLangNotFoundTitle => 'Idioma de estudo não suportado';
  ...
  String get translationLimitMessage =>
      'Você usou todas as suas traduções gratuitas diárias (10 vezes).\\n\\nDeseja assistir a um anúncio para recarregar 10 vezes imediatamente?';
  ...
  String get translationRefilled =>
      'O número de traduções foi recarregado 10 vezes!';
  ...
  @override
  String get typeIdiom => 'Expressão idiomática';

  @override
  String get typeImperative => 'Imperativo';

  @override
  String get typeProverb => 'Provérbio';
  ...
  @override
  String get watchAdAndRefill => 'Assistir ao anúncio e recarregar (+10 vezes)';
  ...
  String get scanAdRefillNotice =>
      'Para recarregar suas traduções, toque no botão abaixo e assista a um anúncio. Clicar no banner de anúncio na parte inferior da tela não fornece recompensas de recarga.';
  ...
  String get scanTranslateMethodSubtitle =>
      'Como você gostaria de traduzir o texto reconhecido?';

  @override
  String get scanBulkTranslate => 'Tradução em lote completa';

  @override
  String get scanBulkTranslateDesc =>
      'Traduz o texto completo em uma única solicitação';

  @override
  String get scanSegmentTranslate => 'Tradução individual';

  @override
  String get scanSegmentTranslateDesc =>
      'Selecione segmentos individualmente para traduzir';

  @override
  String get scanTranslatingAll => 'Traduzindo tudo...';

  @override
  String get scanBulkTranslateButton => 'Traduzir tudo';

  @override
  String scanInsufficientLimit(int needed, int remaining) {
    return 'Limite de traduções insuficiente. Necessário: $needed, Restante: $remaining';
  }

  @override
  String get combinedResult => 'Resultado combinado';

  @override
  String get errorLimitReached =>
      'Você não tem traduções suficientes. Deseja assistir a um anúncio para recarregar 10 traduções?';
  ...
  String get helpLimitDetails =>
      '💡 [Guia de limite de tradução]\n20 traduções gratuitas são fornecidas todos os dias à meia-noite. Se você gastar todas elas, assistir a um anúncio irá recarregar imediatamente 10 traduções adicionais.';

  @override
  String get scanDetails =>
      '• Importe imagens da câmera ou da galeria para extrair e traduzir texto.\n• Você pode tocar em várias frases em uma foto para traduzi-las individualmente.\n• Se você não tiver traduções suficientes, pode assistir a um anúncio para recarregar 10 traduções adicionais imediatamente.';
}
