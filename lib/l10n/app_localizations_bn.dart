...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get helpMode1Details =>
      '• ভাষা সেটিংস: অ্যাপ বার মেনু বা নীচের ভাষা বোতাম ব্যবহার করে আমার ভাষা এবং শেখার ভাষা পরিবর্তন করুন\n• সরল ইনপুট: টেক্সট প্রবেশ করার সময় স্বয়ংক্রিয়ভাবে বিশ্লেষণ (শব্দ/বাক্য) এবং সেটিংস এলাকা সক্রিয় করা হয়\n• মাইক্রোফোন/কীবোর্ড: প্রধান স্ক্রিনে বড় আইকন দিয়ে ভয়েস স্বীকৃতি বা টেক্সট প্রবেশ শুরু করুন\n• বিস্তারিত সেটিংস: ইনপুট করার সময় প্রদর্শিত নীচের ক্ষেত্র থেকে ডেটা সংগ্রহ, ট্যাগ, পরিস্থিতির নোট নির্দিষ্ট করুন\n• স্বয়ংক্রিয় অনুসন্ধান: অনুরূপ বিদ্যমান অনুবাদ রিয়েল-টাইমে সনাক্ত করুন\n• শোনা: স্পিকার আইকন দিয়ে স্থানীয় উচ্চারণ (TTS) প্লে করুন\n• সংরক্ষণ করুন: \'ডেটা সংরক্ষণ করুন\' দিয়ে অবিলম্বে আপনার নিজস্ব শিক্ষার তালিকায় যোগ করুন';
