...
class AppLocalizationsBe extends AppLocalizations {
  ...
  String get helpMode1Details =>
      '• Налады мовы: Змяніце сваю мову і мову навучання ў меню панэлі прыкладанняў або кнопцы мовы ўнізе\n• Просты ўвод: аўтаматычна аналізуе (словы/сказы) і актывуе вобласць налад пры ўводзе тэксту\n• Мікрафон/клавіятура: Пачніце распазнаванне голасу або ўвод тэксту з дапамогай вялікіх значкоў на галоўным экране\n• Падрабязныя налады: Пакажыце зборнікі матэрыялаў, тэгі і сітуацыйныя нататкі ў ніжняй вобласці, якая з\'яўляецца падчас уводу\n• Аўтаматычны пошук: выяўляйце падобныя існуючыя пераклады ў рэжыме рэальнага часу\n• Праслухоўванне: Прайграванне вымаўлення носьбіта мовы (TTS) з дапамогай значка дынаміка\n• Захаванне: Неадкладна дадайце ў свой спіс навучання з дапамогай «Захаваць даныя»';
