...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get translationLimitMessage =>
      'Έχετε χρησιμοποιήσει όλες τις δωρεάν μεταφράσεις της ημέρας (10).\\n\\nΘέλετε να παρακολουθήσετε μια διαφήμιση για να ανανεώσετε αμέσως 10 μεταφράσεις;';

  @override
  String get translationLoaded => 'Φορτώθηκε αποθηκευμένη μετάφραση';

  @override
  String get translationRefilled => 'Οι μεταφράσεις σας ανανεώθηκαν κατά 10!';
  ...
  String get watchAdAndRefill =>
      'Παρακολουθήστε μια διαφήμιση και ανανεώστε (+10)';
