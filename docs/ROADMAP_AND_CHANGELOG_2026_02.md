...
| [x] **Phase 76.5** | **UI/UX Polish** | **완료** | 02.08 | 온라인 자료실 3탭 분리 및 Auto-Select 구현 |
| **Hotfix** | **HomeScreen 빌드 오류 수정** | **완료** | 02.08 | 중복 함수 제거 및 L10n Sync |
...
- **[Hotfix] HomeScreen 빌드 오류**: 중복 함수 정의 제거, `startTutorial` 키 누락 수정, 80개 언어 리소스 동기화.
